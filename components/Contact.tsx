                ...
                <div className="space-y-8 relative z-10 text-center py-4">
                    <div className="space-y-2">
                        ...
                        <a 
                            ...
                            className="text-2xl font-bold text-[#4285F4] hover:text-[#3367D6] transition-colors break-all"
                        >
                    ...
                    <div className="space-y-2">
                        ...
                        <a 
                            ...
                            className="text-2xl font-bold text-[#34A853] hover:text-[#2d8a46] transition-colors"
                        >
                            +91 9625609307
                        </a>
                    </div>
