  ...
  return (
    <div className="space-y-24">
      ...
      >
        ...
        <div className="prose prose-xl text-zinc-600 leading-relaxed max-w-3xl">
          <p>
          ...
          <div className="flex flex-wrap gap-3">
            {['Python', 'C++', 'SQL', 'Pandas', 'NumPy', 'PyTorch', 'TensorFlow', 'Flutter', 'Dart', 'Next.js', 'TypeScript', 'Supabase', 'Cloudflare R2', 'Scikit-learn', 'Git'].map((tech, i) => {
              ...
              return (
                <span
                  key={tech}
                  className={`px-4 py-2 border rounded-lg text-sm font-semibold transition-all cursor-default ${colorClass}`}
                >
                  {tech}
                </span>
              );
      ...
      <motion.section
        ...
        viewport={{ once: true }}
        className="bg-white rounded-3xl p-10 lg:p-14 border border-zinc-200 shadow-md shadow-zinc-200/30"
      >
        <div className="max-w-4xl">
          <h2 className="text-3xl font-bold mb-8 text-zinc-900">The "Why"</h2>
      ...
      <motion.section
        ...
        viewport={{ once: true }}
        className="relative overflow-hidden bg-white rounded-[2.5rem] p-10 lg:p-14 border border-zinc-200 shadow-md shadow-zinc-200/30"
      >
        <div className="max-w-4xl relative z-10">
          <h2 className="text-3xl font-bold mb-6 flex items-center gap-3 text-zinc-900">
             Speech AI Research
          </h2>
      ...
      <div className="space-y-32 pt-12 border-t border-zinc-200">
        <section id="experience" className="space-y-12">
          <h2 className="text-4xl font-bold tracking-tight text-zinc-900">Work & Education</h2>
          <Experience />
        </section>

        <section id="projects" className="space-y-12">
          <h2 className="text-4xl font-bold tracking-tight text-zinc-900">Projects</h2>
          <Projects />
        </section>
